...
reactIs_production_min.isValidElementType = function(a) {
  return "string" === typeof a || "function" === typeof a || a === e || a === m$1 || a === g || a === f || a === p$1 || a === q$1 || "object" === typeof a && null !== a && (a.$$typeof === t || a.$$typeof === r || a.$$typeof === h || a.$$typeof === k || a.$$typeof === n || a.$$typeof === w$1 || a.$$typeof === x || a.$$typeof === y || a.$$typeof === v$1);
};
...
function hd(a, b2, c2, d2, e2) {
  ...
  Jb(function() {
    ...
    if (0 === (b2 & 7)) {
      ...
      if ($a = ce ? je$1(a, c2) : ke(a, c2)) d3 = oe(d3, "onBeforeInput"), 0 < d3.length && (e3 = new Ld("onBeforeInput", "beforeinput", null, c2, e3), g3.push({ event: e3, listeners: d3 }), e3.data = $a);
    }
    se(g3, b2);
  });
}
...
function InfoText({
  ...
  return /* @__PURE__ */ jsxs("div", { css: infoLayout, children: [
    showImg && /* @__PURE__ */ jsx$1("img", { src: "/react-shopping-cart/info.png", css: infoImg }),
    /* @__PURE__ */ jsx$1("p", { css: intoText, children })
  ] });
}
function useModal() {
...
function useSelectedCartIds() {
  ...
  const toggleSelectAll = (cartItems, init) => {
  ...
  const toggleCartItem = (id2) => {
    if (selectedCartIds.includes(id2)) removeFromSelection(id2);
    else setSelectedCartIds([...selectedCartIds, id2]);
  };
...
const SelectedCartContext = reactExports.createContext(null);
const SelectedCartProvider = ({
  children
}) => {
  const {
    toggleSelectAll,
  ...
  return /* @__PURE__ */ jsx$1(SelectedCartContext.Provider, { value: contextValue, children });
};
function useSelectedCartContext() {
...
function PaymentSummary({
  ...
  return /* @__PURE__ */ jsxs("div", { css: paymentSummaryLayout, children: [
    /* @__PURE__ */ jsx$1(InfoText, { showImg: true, children: "총 주문 금액이 100,000원 이상일 경우 무료 배송됩니다." }),
    /* @__PURE__ */ jsx$1(Line, {}),
    /* @__PURE__ */ jsxs("div", { css: summaryRowBox, children: [
      ...
      couponSale !== void 0 && /* @__PURE__ */ jsx$1(
        SummaryRow,
        {
          text: "쿠폰 할인 금액",
          price: -couponSale,
...
const ErrorProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx$1(ErrorContext.Provider, { value: { error, setError }, children });
};
...
function useAsync(asyncFn, errorMessage) {
...
const apiClient = {
  delete: (url, id2) => fetch(`${baseUrl}/${url}/${id2}`, getRequestHeaders("DELETE")),
  get: (url, params) => {
    const queryParams = params ? `?${params.toString()}` : "";
    return fetch(`${baseUrl}/${url}${queryParams}`, getRequestHeaders("GET"));
  },
  patch: (url, id2, body) => fetch(`${baseUrl}/${url}/${id2}`, getRequestHeaders("PATCH", body))
};
...
function Coupon({
  ...
  var _a, _b;
  return /* @__PURE__ */ jsxs("div", { css: couponLayout(isDisabled), id: item.code, children: [
    /* @__PURE__ */ jsxs("div", { css: checkBoxLayout, children: [
      /* @__PURE__ */ jsx$1(
        CheckBox,
        {
          checked: isSelected,
      ...
      /* @__PURE__ */ jsx$1("p", { children: item.description })
    ] }),
    /* @__PURE__ */ jsxs("div", { css: infoTextLayout, children: [
      /* @__PURE__ */ jsxs(InfoText, { children: [
        "만료일: ",
        new Date(item.expirationDate).toLocaleDateString()
      ] }),
      item.minimumAmount && /* @__PURE__ */ jsxs(InfoText, { children: [
        "최소 주문 금액 : ",
        item.minimumAmount,
        " "
      ] }),
      item.availableTime && /* @__PURE__ */ jsxs(InfoText, { children: [
        "사용 가능 시간 : ",
        formatToKoreanAmPm((_a = item.availableTime) == null ? void 0 : _a.start),
        "부터 ",
        formatToKoreanAmPm((_b = item.availableTime) == null ? void 0 : _b.end),
        "까지"
      ] })
    ] })
  ] });
...
function CouponList({
  ...
  return /* @__PURE__ */ jsx$1(Fragment, { children: coupons.map((coupon) => {
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx$1(Line, {}, `${coupon.code}-line`),
      /* @__PURE__ */ jsx$1(
        Coupon,
        {
          item: coupon,
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { css: TitleLayout, children: [
          /* @__PURE__ */ jsxs("div", { css: ProductBox, children: [
...
const cartListLayout = css`
  display: flex;
  flex-direction: column;
  gap: 12px;
  width: 100%;
`;
function SelectedCartList({
  cartItems
}) {
  const { selectedCartIds } = useSelectedCartContext();
  return /* @__PURE__ */ jsx$1("div", { css: cartListLayout, children: cartItems.filter((item) => selectedCartIds.includes(item.id.toString())).map((item) => {
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx$1(Line, {}),
      /* @__PURE__ */ jsx$1(
        CartProduct,
...
const extraDetailLayout = css`
  ...
  gap: 4px;
`;
function SelectedCartContainer({
  handleModalOpen,
  isExtraDeliveryArea,
  handleCheckBox,
  cartItems
}) {
  return /* @__PURE__ */ jsxs("section", { css: selectedCartContainerLayout, children: [
    /* @__PURE__ */ jsx$1(SelectedCartList, { cartItems }),
    /* @__PURE__ */ jsx$1(Button, { onClick: handleModalOpen, style: "ghost", size: "full", children: "쿠폰 적용" }),
    /* @__PURE__ */ jsxs("div", { css: selectedDeliveryInfo, children: [
      /* @__PURE__ */ jsx$1("p", { css: deliveryInfoText, children: "배송 정보" }),
      /* @__PURE__ */ jsxs("div", { css: extraDetailLayout, children: [
        /* @__PURE__ */ jsx$1(
          CheckBox,
          {
        ...
        /* @__PURE__ */ jsx$1("label", { htmlFor: "extra-delivery-area", children: "제주도 및 도서 산간 지역" })
      ] })
    ] })
  ] });
}
...
function getDeliveryFee({
  ...
  const deliveryFee = 1e5 <= orderPrice ? 0 : 3e3;
  if (isExtraDeliveryArea) return deliveryFee + 3e3;
  return deliveryFee;
}
function getDisCountedPrice(props) {
...
function applyCouponDiscounts(selectedCoupons, props) {
  return selectedCoupons.reduce((acc, couponCode) => {
    return acc + getCouponDiscountAmount({
      ...props,
...
function usePaymentSummary({
  ...
  const deliveryFee = reactExports.useMemo(
    () => getDeliveryFee({ orderPrice, isExtraDeliveryArea }),
    [orderPrice, isExtraDeliveryArea]
  );
  const discountedPrice = reactExports.useMemo(
    () => getDisCountedPrice({
      deliveryFee,
      orderPrice,
...
function useSelectedCoupons() {
  const [selectedCoupons, setSelectedCoupons] = reactExports.useState([]);
  const handleCouponSelect = (e2) => {
    const couponCode = e2.target.id;
    setSelectedCoupons((prev2) => {
      if (prev2.includes(couponCode))
        return prev2.filter((id2) => id2 !== couponCode);
      if (prev2.length < 2) {
        return [...prev2, couponCode];
      }
      return prev2;
    });
  };
...
function useTwoPlusOneItems({
  cartItems
}) {
  const { selectedCartIds } = useSelectedCartContext();
  const twoPlusOneApplicableItems = reactExports.useMemo(() => {
...
function validateDate({ expirationDate, today }) {
  return new Date(expirationDate) >= today;
}
function validateTime({ availableTime, today }) {
...
const validateCoupon = (couponCode, orderPrice, selectedCartItems, coupons) => {
  ...
  if (couponItem.code === "BOGO" && selectedCartItems.length === 0)
    return false;
  return validateDate({ expirationDate: couponItem.expirationDate, today }) && (!couponItem.availableTime || validateTime({ availableTime: couponItem.availableTime, today })) && (!couponItem.minimumAmount || validateMinimumAmount({
...
(function() {
  try {
    if (typeof document < "u") {
      ...
      o.appendChild(document.createTextNode("p{margin:0;padding:0}.ModalHeader-module__modalHeader___fmpx1{display:flex;justify-content:space-between;align-items:center;width:100%}.ModalHeader-module__closeButton___1EMwa{width:18px;height:18px}.ModalHeader-module__closeButton___1EMwa:hover{cursor:pointer}.ModalHeader-module__title___YFwtR{font-family:Noto Sans KR;font-weight:700;font-size:18px;width:fit-content;overflow:hidden;text-overflow:ellipsis;max-width:calc(100% - 20px)}.ModalContent-module__modalContent___--nd1{display:flex;flex-direction:column;gap:8px;font-family:Noto Sans;font-weight:500;font-size:12px;color:#0a0d13;width:100%}.ModalFooter-module__modalFooter___yldzh{width:100%}.Modal-module__center___amMqR{justify-content:center;align-items:center}.Modal-module__bottom___W3wMy{justify-content:center;align-items:end}.Modal-module__smModal___1H63k{width:382px}.Modal-module__mdModal___RPjYx{width:480px}.Modal-module__lgModal___oRNj8{width:600px}.Modal-module__modal___42I6x{width:320px}.Modal-module__modalBackground___VJ5KQ{position:fixed;display:flex;top:0;left:0;width:100vw;height:100vh;background-color:#00000059;z-index:9999}.Modal-module__modalContents___eShHb{display:flex;flex-direction:column;gap:16px;padding:24px 32px;box-sizing:border-box;background:#fff;color:#000;border-radius:8px}.ModalButton-module__alertButtonContainer___3E7Du{width:100%;display:flex;justify-content:right;align-items:center}.ModalButton-module__buttonContainer___pFaUf{display:flex;gap:12px}.ModalButton-module__button___Lfxty{width:80px;height:36px;border-radius:5px;font-family:Noto Sans KR;font-weight:700;font-size:15px;text-align:center;vertical-align:middle;cursor:pointer;transition:all .2s ease}.ModalButton-module__button___Lfxty:hover{opacity:.9}.ModalButton-module__button___Lfxty:focus{outline:2px solid #4d90fe}.ModalButton-module__button___Lfxty:active{transform:scale(.98)}.ModalButton-module__primaryButton___uEdgf{background-color:#333;color:#fff}.ModalButton-module__secondaryButton___88hhZ{color:#333;border:1px solid #33333340;background-color:#fff}.ModalPrompt-module__inputPrompt___rD-nq{width:100%;height:32px;border-radius:2px;gap:8px;padding:8px;border:1px solid #000000;box-sizing:border-box;background-color:#fff}.ModalPrompt-module__inputPrompt___rD-nq::placeholder{font-family:Inter;font-weight:400;font-size:11px;color:#000}.ModalPrompt-module__inputPrompt___rD-nq:focus{outline:none;border-color:#06f;box-shadow:0 0 0 2px #0066ff40}")), document.head.appendChild(o);
    }
  } catch (t2) {
...
function Er() {
  if (je) return $;
  je = 1;
  var u2 = React, s = Symbol.for("react.element"), f2 = Symbol.for("react.fragment"), d2 = Object.prototype.hasOwnProperty, E2 = u2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, x2 = { key: true, ref: true, __self: true, __source: true };
  function C2(g2, m2, T2) {
    var h2, A2 = {}, P2 = null, N2 = null;
    T2 !== void 0 && (P2 = "" + T2), m2.key !== void 0 && (P2 = "" + m2.key), m2.ref !== void 0 && (N2 = m2.ref);
    for (h2 in m2) d2.call(m2, h2) && !x2.hasOwnProperty(h2) && (A2[h2] = m2[h2]);
    if (g2 && g2.defaultProps) for (h2 in m2 = g2.defaultProps, m2) A2[h2] === void 0 && (A2[h2] = m2[h2]);
    return { $$typeof: s, type: g2, key: P2, ref: N2, props: A2, _owner: E2.current };
  }
  return $.Fragment = f2, $.jsx = C2, $.jsxs = C2, $;
}
var Oe;
function Cr() {
  return Oe || (Oe = 1, H.exports = Er()), H.exports;
}
var b = Cr();
const Me = reactExports.createContext(null), xr = () => {
  const u2 = reactExports.useContext(Me);
  if (!u2)
    throw new Error("useModal must be used within a ModalProvider");
  return u2;
}, Ar = "ModalHeader-module__modalHeader___fmpx1", wr = "ModalHeader-module__closeButton___1EMwa", Tr = "ModalHeader-module__title___YFwtR", re = {
  modalHeader: Ar,
  closeButton: wr,
  title: Tr
}, jr = "data:image/png;base64,";
function Pr({
  children: u2,
  hasCloseButton: s = false
}) {
  const { onClose: f2 } = xr();
  return /* @__PURE__ */ b.jsxs("header", { className: re.modalHeader, children: [
    /* @__PURE__ */ b.jsx("p", { className: re.title, children: u2 }),
    s && /* @__PURE__ */ b.jsx(
      "img",
      {
        ...
        tabIndex: 0,
        onKeyDown: (d2) => d2.key === "Enter" && f2(),
        role: "button"
      }
    )
  ] });
}
const Or = "ModalContent-module__modalContent___--nd1", Sr = {
  modalContent: Or
};
function kr({ children: u2 }) {
  return /* @__PURE__ */ b.jsx("main", { className: Sr.modalContent, children: u2 });
}
const Mr = "ModalFooter-module__modalFooter___yldzh", Fr = {
  modalFooter: Mr
};
function Br({ children: u2 }) {
  return /* @__PURE__ */ b.jsx("footer", { className: Fr.modalFooter, children: u2 });
}
function Dr({
  targetKey: u2,
  enabled: s,
  ...
  reactExports.useEffect(() => {
    ...
    return window.addEventListener("keydown", d2), () => window.removeEventListener("keydown", d2);
  }, [s, f2, u2]);
}
const Ir = "Modal-module__center___amMqR", $r = "Modal-module__bottom___W3wMy", Yr = "Modal-module__smModal___1H63k", Nr = "Modal-module__mdModal___RPjYx", Wr = "Modal-module__lgModal___oRNj8", Lr = "Modal-module__modal___42I6x", Ur = "Modal-module__modalBackground___VJ5KQ", Vr = "Modal-module__modalContents___eShHb", q = {
  center: Ir,
  bottom: $r,
  smModal: Yr,
  mdModal: Nr,
...
function Hr({ modalRef: u2, isOpen: s }) {
  reactExports.useEffect(() => {
    const f2 = u2.current;
    if (!f2) return;
    const d2 = f2.querySelectorAll(
      'button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'
    );
    if (!d2.length) return;
    const E2 = d2[0], x2 = d2[d2.length - 1], C2 = (g2) => {
      g2.key === "Tab" && (g2.shiftKey ? document.activeElement === E2 && (g2.preventDefault(), x2.focus()) : document.activeElement === x2 && (g2.preventDefault(), E2.focus()));
    };
    return document.addEventListener("keydown", C2), E2.focus(), () => {
...
function qr({
  ...
  children: d2,
  size: E2 = "md",
  backdropClosable: x2 = false
}) {
  const C2 = reactExports.useRef(null);
  Hr({ modalRef: C2, isOpen: s });
  const g2 = `${q[u2]} ${q.modalBackground}`, m2 = `${q.modalContents} ${q[`${E2}Modal`]}`;
  return Dr({
    targetKey: "Escape",
    enabled: !(s && x2),
    onKeyMatch: f2
  }), s ? reactDomExports.createPortal(
    /* @__PURE__ */ b.jsx(Me.Provider, { value: { isOpen: s, onClose: f2, position: u2 }, children: /* @__PURE__ */ b.jsx(
      "div",
      {
...
const Gr = "ModalButton-module__alertButtonContainer___3E7Du", Kr = "ModalButton-module__buttonContainer___pFaUf", Jr = "ModalButton-module__button___Lfxty", zr = "ModalButton-module__primaryButton___uEdgf", Xr = "ModalButton-module__secondaryButton___88hhZ", w = {
  alertButtonContainer: Gr,
  buttonContainer: Kr,
  button: Jr,
  primaryButton: zr,
  secondaryButton: Xr
};
function Zr({ buttonText: u2, onClick: s }) {
  return /* @__PURE__ */ b.jsx("div", { className: w.alertButtonContainer, children: /* @__PURE__ */ b.jsx(
    "button",
    {
      className: `${w.button} ${w.primaryButton}`,
      tabIndex: 0,
      onClick: s,
      children: u2 ?? "확인"
    }
...
function Qr({
  ...
  return /* @__PURE__ */ b.jsx("div", { className: w.alertButtonContainer, children: /* @__PURE__ */ b.jsxs("div", { className: w.buttonContainer, children: [
    /* @__PURE__ */ b.jsx(
      "button",
      {
        className: `${w.button} ${w.secondaryButton}`,
        tabIndex: 0,
        onClick: d2,
        children: s ?? "취소"
      }
...
const et = "ModalPrompt-module__inputPrompt___rD-nq", rt = {
  inputPrompt: et
};
function tt({
  value: u2,
...
function CouponModal({
  ...
  return /* @__PURE__ */ jsxs(
    B,
    {
      ...
      children: [
        /* @__PURE__ */ jsx$1(B.Header, { hasCloseButton: true, children: "쿠폰을 선택해주세요" }),
        /* @__PURE__ */ jsx$1(B.Content, { children }),
        /* @__PURE__ */ jsx$1(B.Footer, { children: /* @__PURE__ */ jsxs(Button, { onClick: handleModalClose, size: "full", children: [
          "총 ",
...
function OrderConfirm() {
  ...
  const [isExtraDeliveryArea, setIsExtraDeliveryArea] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxs(PageLayout, { children: [
    /* @__PURE__ */ jsx$1(Header, { children: /* @__PURE__ */ jsx$1("button", { css: pressBackButton, onClick: goHome, children: /* @__PURE__ */ jsx$1("img", { src: "/react-shopping-cart/arrowBack.png", alt: "뒤로가기" }) }) }),
    /* @__PURE__ */ jsxs(Main, { children: [
      /* @__PURE__ */ jsxs("div", { css: titleBox, children: [
        /* @__PURE__ */ jsx$1("p", { css: titleStyle, children: "주문 확인" }),
        /* @__PURE__ */ jsxs("p", { css: subTitleStyle, children: [
          "총 ",
      ...
      /* @__PURE__ */ jsx$1(
        SelectedCartContainer,
        {
          ...
          isExtraDeliveryArea,
          handleCheckBox: () => setIsExtraDeliveryArea((prev2) => !prev2),
          cartItems
        }
      ),
      /* @__PURE__ */ jsx$1(
    ...
    /* @__PURE__ */ jsxs(
      CouponModal,
      {
        ...
        discountedPrice,
        children: [
          /* @__PURE__ */ jsx$1(InfoText, { showImg: true, children: "쿠폰은 최대 2개까지 사용할 수 있습니다." }),
          /* @__PURE__ */ jsx$1(
            CouponList,
            {
              handleCouponSelect,
...
function usePatchCartItem() {
  const { run, loading } = useAsync(
    (id2, quantity) => patchShoppingCart(id2, quantity),
    "수량 변경에 실패했어요."
  );
  const patchCartItem = async (id2, quantity) => {
    return await run(id2, quantity);
  };
...
function CartProductContainer({
  ...
  return /* @__PURE__ */ jsx$1("section", { css: CartProductList, children: cartItems.map((item) => {
...
function useDeleteCartItem() {
  const { run, loading } = useAsync(
    (id2) => deleteShoppingCart(id2),
    "장바구니 데이터 삭제에 실패했습니다"
  );
  const deleteCartItem = async (id2) => {
    return await run(id2);
  };
...
function ShoppingCart() {
  ...
  const orderPrice = getOrderPrice({ cartItems, selectedCartIds });
  const handleConfirm = () => {
  ...
  return /* @__PURE__ */ jsxs(PageLayout, { children: [
    ...
    /* @__PURE__ */ jsxs(Main, { children: [
      /* @__PURE__ */ jsxs("div", { css: titleBox, children: [
        ...
        cartItems.length !== 0 && /* @__PURE__ */ jsx$1("p", { css: subTitleStyle, children: "현재 2종류의 상품이 담겨있습니다." })
      ] }),
      cartItems.length === 0 ? /* @__PURE__ */ jsx$1(EmptyShoppingCart, {}) : /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("div", { css: CartProductContainerLayout, children: [
          ...
          /* @__PURE__ */ jsx$1(
            CartProductContainer,
            {
              selectedCartIds,
              onDelete: async (id2) => {
                const response = await deleteCartItem(id2);
                if (!response || !response.ok) return;
                await refetchCartItems();
                removeFromSelection(id2);
              },
              handleCheckBox: (e2) => toggleCartItem(e2.target.id),
              cartItems,
              refetchCartItems
            }
          )
...
function NotFoundPage() {
  return /* @__PURE__ */ jsxs("div", { css: notFoundPageLayout, children: [
    /* @__PURE__ */ jsx$1("h1", { css: notFoundPageTitle, children: "404 Not Found" }),
    /* @__PURE__ */ jsxs("p", { css: notFoundPageMessage, children: [
      "요청하신 페이지를 찾을 수 없습니다. ",
      /* @__PURE__ */ jsx$1("br", {}),
...
const shoppingCartRoute = createBrowserRouter(
  [
    {
      path: "/",
      element: /* @__PURE__ */ jsx$1(ShoppingCart, {}),
      errorElement: /* @__PURE__ */ jsx$1(NotFoundPage, {})
    },
    {
      path: "/order-confirm",
      element: /* @__PURE__ */ jsx$1(OrderConfirm, {}),
      errorElement: /* @__PURE__ */ jsx$1(NotFoundPage, {})
    },
    {
      path: "/payment-complete",
      element: /* @__PURE__ */ jsx$1(PaymentComplete, {}),
      errorElement: /* @__PURE__ */ jsx$1(NotFoundPage, {})
    }
  ],
  {
...
function App() {
  return /* @__PURE__ */ jsx$1(ErrorProvider, { children: /* @__PURE__ */ jsx$1(SelectedCartProvider, { children: /* @__PURE__ */ jsx$1(RouterProvider2, { router: shoppingCartRoute }) }) });
}
